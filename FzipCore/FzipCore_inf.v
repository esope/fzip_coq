...
Fixpoint close_typ_wrt_typ_rec (n1 : nat) (a1 : typvar) (t1 : typ) {struct t1} : typ :=
  match t1 with
    ...
    | typ_prod t2 t3 => typ_prod (close_typ_wrt_typ_rec n1 a1 t2) (close_typ_wrt_typ_rec n1 a1 t3)
    | typ_forall t2 => typ_forall (close_typ_wrt_typ_rec (S n1) a1 t2)
    | typ_exists t2 => typ_exists (close_typ_wrt_typ_rec (S n1) a1 t2)
  end.
...
Fixpoint close_term_wrt_term_rec (n1 : nat) (x1 : termvar) (e1 : term) {struct e1} : term :=
  match e1 with
    ...
    | term_exists e2 => term_exists (close_term_wrt_term_rec n1 x1 e2)
    | term_open t1 e2 => term_open t1 (close_term_wrt_term_rec n1 x1 e2)
    | term_nu e2 => term_nu (close_term_wrt_term_rec n1 x1 e2)
    | term_sigma t1 t2 e2 => term_sigma t1 t2 (close_term_wrt_term_rec n1 x1 e2)
    | term_coerce e2 t1 => term_coerce (close_term_wrt_term_rec n1 x1 e2) t1
  end.
...
Fixpoint close_term_wrt_typ_rec (n1 : nat) (a1 : typvar) (e1 : term) {struct e1} : term :=
  match e1 with
    ...
    | term_exists e2 => term_exists (close_term_wrt_typ_rec (S n1) a1 e2)
    | term_open t1 e2 => term_open (close_typ_wrt_typ_rec n1 a1 t1) (close_term_wrt_typ_rec n1 a1 e2)
    | term_nu e2 => term_nu (close_term_wrt_typ_rec (S n1) a1 e2)
    | term_sigma t1 t2 e2 => term_sigma (close_typ_wrt_typ_rec n1 a1 t1) (close_typ_wrt_typ_rec n1 a1 t2) (close_term_wrt_typ_rec (S n1) a1 e2)
    | term_coerce e2 t1 => term_coerce (close_term_wrt_typ_rec n1 a1 e2) (close_typ_wrt_typ_rec n1 a1 t1)
  end.
...
Fixpoint size_term (e1 : term) {struct e1} : nat :=
  match e1 with
    ...
    | term_exists e2 => 1 + (size_term e2)
    | term_open t1 e2 => 1 + (size_typ t1) + (size_term e2)
    | term_nu e2 => 1 + (size_term e2)
    | term_sigma t1 t2 e2 => 1 + (size_typ t1) + (size_typ t2) + (size_term e2)
    | term_coerce e2 t1 => 1 + (size_term e2) + (size_typ t1)
  end.
...
Inductive degree_typ_wrt_typ : nat -> typ -> Prop :=
  ...
  | degree_wrt_typ_typ_prod : forall n1 t1 t2,
    degree_typ_wrt_typ n1 t1 ->
    degree_typ_wrt_typ n1 t2 ->
    degree_typ_wrt_typ n1 (typ_prod t1 t2)
  | degree_wrt_typ_typ_forall : forall n1 t1,
    degree_typ_wrt_typ (S n1) t1 ->
    degree_typ_wrt_typ n1 (typ_forall t1)
  | degree_wrt_typ_typ_exists : forall n1 t1,
    degree_typ_wrt_typ (S n1) t1 ->
    degree_typ_wrt_typ n1 (typ_exists t1).
...
Inductive degree_term_wrt_term : nat -> term -> Prop :=
  ...
  | degree_wrt_term_term_pair : forall n1 e1 e2,
    degree_term_wrt_term n1 e1 ->
    degree_term_wrt_term n1 e2 ->
    degree_term_wrt_term n1 (term_pair e1 e2)
  | degree_wrt_term_term_fst : forall n1 e1,
    degree_term_wrt_term n1 e1 ->
    degree_term_wrt_term n1 (term_fst e1)
  | degree_wrt_term_term_snd : forall n1 e1,
    degree_term_wrt_term n1 e1 ->
    degree_term_wrt_term n1 (term_snd e1)
  ...
  | degree_wrt_term_term_exists : forall n1 e1,
    degree_term_wrt_term n1 e1 ->
    degree_term_wrt_term n1 (term_exists e1)
  | degree_wrt_term_term_open : forall n1 t1 e1,
    degree_term_wrt_term n1 e1 ->
    degree_term_wrt_term n1 (term_open t1 e1)
  | degree_wrt_term_term_nu : forall n1 e1,
    degree_term_wrt_term n1 e1 ->
    degree_term_wrt_term n1 (term_nu e1)
  | degree_wrt_term_term_sigma : forall n1 t1 t2 e1,
    degree_term_wrt_term n1 e1 ->
    degree_term_wrt_term n1 (term_sigma t1 t2 e1)
  | degree_wrt_term_term_coerce : forall n1 e1 t1,
    degree_term_wrt_term n1 e1 ->
    degree_term_wrt_term n1 (term_coerce e1 t1).
...
Inductive degree_term_wrt_typ : nat -> term -> Prop :=
  ...
  | degree_wrt_typ_term_pair : forall n1 e1 e2,
    degree_term_wrt_typ n1 e1 ->
    degree_term_wrt_typ n1 e2 ->
    degree_term_wrt_typ n1 (term_pair e1 e2)
  | degree_wrt_typ_term_fst : forall n1 e1,
    degree_term_wrt_typ n1 e1 ->
    degree_term_wrt_typ n1 (term_fst e1)
  | degree_wrt_typ_term_snd : forall n1 e1,
    degree_term_wrt_typ n1 e1 ->
    degree_term_wrt_typ n1 (term_snd e1)
  ...
  | degree_wrt_typ_term_exists : forall n1 e1,
    degree_term_wrt_typ (S n1) e1 ->
    degree_term_wrt_typ n1 (term_exists e1)
  | degree_wrt_typ_term_open : forall n1 t1 e1,
    degree_typ_wrt_typ n1 t1 ->
    degree_term_wrt_typ n1 e1 ->
    degree_term_wrt_typ n1 (term_open t1 e1)
  | degree_wrt_typ_term_nu : forall n1 e1,
    degree_term_wrt_typ (S n1) e1 ->
    degree_term_wrt_typ n1 (term_nu e1)
  | degree_wrt_typ_term_sigma : forall n1 t1 t2 e1,
    degree_typ_wrt_typ n1 t1 ->
    degree_typ_wrt_typ n1 t2 ->
    degree_term_wrt_typ (S n1) e1 ->
    degree_term_wrt_typ n1 (term_sigma t1 t2 e1)
  | degree_wrt_typ_term_coerce : forall n1 e1 t1,
    degree_term_wrt_typ n1 e1 ->
    degree_typ_wrt_typ n1 t1 ->
    degree_term_wrt_typ n1 (term_coerce e1 t1).
...
Inductive lc_set_term : term -> Set :=
  ...
  | lc_set_term_pair : forall e1 e2,
    lc_set_term e1 ->
    lc_set_term e2 ->
    lc_set_term (term_pair e1 e2)
  | lc_set_term_fst : forall e1,
    lc_set_term e1 ->
    lc_set_term (term_fst e1)
  | lc_set_term_snd : forall e1,
    lc_set_term e1 ->
    lc_set_term (term_snd e1)
  ...
  | lc_set_term_exists : forall e1,
    (forall a1 : typvar, lc_set_term (open_term_wrt_typ e1 (typ_var_f a1))) ->
    lc_set_term (term_exists e1)
  | lc_set_term_open : forall t1 e1,
    lc_set_typ t1 ->
    lc_set_term e1 ->
    lc_set_term (term_open t1 e1)
  | lc_set_term_nu : forall e1,
    (forall a1 : typvar, lc_set_term (open_term_wrt_typ e1 (typ_var_f a1))) ->
    lc_set_term (term_nu e1)
  | lc_set_term_sigma : forall t1 t2 e1,
    lc_set_typ t1 ->
    lc_set_typ t2 ->
    (forall a1 : typvar, lc_set_term (open_term_wrt_typ e1 (typ_var_f a1))) ->
    lc_set_term (term_sigma t1 t2 e1)
  | lc_set_term_coerce : forall e1 t1,
    lc_set_term e1 ->
    lc_set_typ t1 ->
    lc_set_term (term_coerce e1 t1).
...
Lemma lc_typ_exists_exists :
forall a1 t1,
  lc_typ (open_typ_wrt_typ t1 (typ_var_f a1)) ->
  lc_typ (typ_exists t1).
Proof.
intros; typ_lc_exists_tac; eauto with lngen.
Qed.
...
Lemma lc_term_exists_exists :
forall a1 e1,
  lc_term (open_term_wrt_typ e1 (typ_var_f a1)) ->
  lc_term (term_exists e1).
Proof.
intros; term_lc_exists_tac; eauto with lngen.
Qed.

Lemma lc_term_nu_exists :
forall a1 e1,
  lc_term (open_term_wrt_typ e1 (typ_var_f a1)) ->
  lc_term (term_nu e1).
Proof.
...
Lemma lc_term_sigma_exists :
forall a1 t1 t2 e1,
  lc_typ t1 ->
  lc_typ t2 ->
  lc_term (open_term_wrt_typ e1 (typ_var_f a1)) ->
  lc_term (term_sigma t1 t2 e1).
Proof.
intros; term_lc_exists_tac; eauto with lngen.
Qed.
...
Hint Extern 1 (lc_typ (typ_exists _)) =>
  let a1 := fresh in
  pick_fresh a1;
  apply (lc_typ_exists_exists a1).
...
Hint Extern 1 (lc_term (term_exists _)) =>
  let a1 := fresh in
  pick_fresh a1;
  apply (lc_term_exists_exists a1).

Hint Extern 1 (lc_term (term_nu _)) =>
  let a1 := fresh in
  pick_fresh a1;
  apply (lc_term_nu_exists a1).

Hint Extern 1 (lc_term (term_sigma _ _ _)) =>
  let a1 := fresh in
  pick_fresh a1;
  apply (lc_term_sigma_exists a1).
...
Hint Resolve lc_body_typ_exists_1 : lngen.
...
Hint Resolve lc_body_term_exists_1 : lngen.

Lemma lc_body_term_nu_1 :
forall e1,
  lc_term (term_nu e1) ->
  body_term_wrt_typ e1.
Proof.
...
Hint Resolve lc_body_term_nu_1 : lngen.

Lemma lc_body_term_sigma_3 :
forall t1 t2 e1,
  lc_term (term_sigma t1 t2 e1) ->
  body_term_wrt_typ e1.
Proof.
...
Hint Resolve lc_body_term_sigma_3 : lngen.
...
Lemma tsubst_typ_typ_exists :
forall a2 t2 t1 a1,
  lc_typ t1 ->
  a2 `notin` ftv_typ t1 `union` ftv_typ t2 `union` singleton a1 ->
  tsubst_typ t1 a1 (typ_exists t2) = typ_exists (close_typ_wrt_typ a2 (tsubst_typ t1 a1 (open_typ_wrt_typ t2 (typ_var_f a2)))).
Proof.
default_simp.
Qed.

Hint Resolve tsubst_typ_typ_exists : lngen.
...
Lemma subst_term_term_exists :
forall a1 e2 e1 x1,
  lc_term e1 ->
  a1 `notin` ftv_term e1 `union` ftv_term e2 ->
  subst_term e1 x1 (term_exists e2) = term_exists (close_term_wrt_typ a1 (subst_term e1 x1 (open_term_wrt_typ e2 (typ_var_f a1)))).
Proof.
default_simp.
Qed.

Hint Resolve subst_term_term_exists : lngen.

Lemma subst_term_term_nu :
forall a1 e2 e1 x1,
  lc_term e1 ->
  a1 `notin` ftv_term e1 `union` ftv_term e2 ->
  subst_term e1 x1 (term_nu e2) = term_nu (close_term_wrt_typ a1 (subst_term e1 x1 (open_term_wrt_typ e2 (typ_var_f a1)))).
Proof.
default_simp.
Qed.

Hint Resolve subst_term_term_nu : lngen.

Lemma subst_term_term_sigma :
forall a1 t1 t2 e2 e1 x1,
  lc_term e1 ->
  a1 `notin` ftv_term e1 `union` ftv_term e2 ->
  subst_term e1 x1 (term_sigma t1 t2 e2) = term_sigma (t1) (t2) (close_term_wrt_typ a1 (subst_term e1 x1 (open_term_wrt_typ e2 (typ_var_f a1)))).
Proof.
default_simp.
Qed.

Hint Resolve subst_term_term_sigma : lngen.
...
Lemma tsubst_term_term_exists :
forall a2 e1 t1 a1,
  lc_typ t1 ->
  a2 `notin` ftv_typ t1 `union` ftv_term e1 `union` singleton a1 ->
  tsubst_term t1 a1 (term_exists e1) = term_exists (close_term_wrt_typ a2 (tsubst_term t1 a1 (open_term_wrt_typ e1 (typ_var_f a2)))).
Proof.
default_simp.
Qed.

Hint Resolve tsubst_term_term_exists : lngen.

Lemma tsubst_term_term_nu :
forall a2 e1 t1 a1,
  lc_typ t1 ->
  a2 `notin` ftv_typ t1 `union` ftv_term e1 `union` singleton a1 ->
  tsubst_term t1 a1 (term_nu e1) = term_nu (close_term_wrt_typ a2 (tsubst_term t1 a1 (open_term_wrt_typ e1 (typ_var_f a2)))).
Proof.
default_simp.
Qed.

Hint Resolve tsubst_term_term_nu : lngen.

Lemma tsubst_term_term_sigma :
forall a2 t2 t3 e1 t1 a1,
  lc_typ t1 ->
  a2 `notin` ftv_typ t1 `union` ftv_term e1 `union` singleton a1 ->
  tsubst_term t1 a1 (term_sigma t2 t3 e1) = term_sigma (tsubst_typ t1 a1 t2) (tsubst_typ t1 a1 t3) (close_term_wrt_typ a2 (tsubst_term t1 a1 (open_term_wrt_typ e1 (typ_var_f a2)))).
Proof.
default_simp.
Qed.

Hint Resolve tsubst_term_term_sigma : lngen.
